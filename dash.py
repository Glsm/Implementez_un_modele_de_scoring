...
html_temp = """
    <div style="background-color: gray; padding:1px; border-radius:10px">
    <h1 style="color: white; text-align:center">Scoring Crédit</h1>
    </div>
...
if (int(id_client) in id_list):
    ...
    if (show_credit_decision):
        ...
        with st.spinner('Chargement du score du client...'):
            ...
            if classe_predite == 1:
                decision = ' Négatif (Crédit Refusé)'
            else:
                decision = ' Positif (Crédit Accordé)'
